...
describe('Collections', () => {
	...
	describe('By Team - [/team/:teamId]', () => {
		...
		it('Should create a new collection', () => {
			...
			cy.intercept('POST', `${apiUrl}/team/*/collection`, {
				fixture: './collections/new-collection.json',
			});
			...
			cy.getBySel('collection-empty-invocation-img')
				.should('be.visible')
				.and('have.attr', 'alt', collections.img.emptyInvocation.alt);
			cy.getBySel('collection-empty-invocation-description').should(
				'be.visible',
			);
			cy.getBySel('collection-empty-invocation-description')
				.find('h1')
		...
		it('Should edit a collection name', () => {
			...
			cy.intercept('PATCH', `${apiUrl}/team/*/collection`, {
				body: {
					id: '28a5e963-8635-4a26-863b-6fd477230bf0',
					name: 'Edit Collection',
				},
		...
		it('Should delete a collection', () => {
			...
			cy.intercept('DELETE', `${`${apiUrl}/team/*/collection`}/*`, {
				body: collectionId,
			}).as('deleteCollection');
			cy.wait('@getCollections');
			cy.intercept('GET', `${apiUrl}/team/*/collection`, {
