...
export function AuthProvider({
  ...
  const onCreateAccountEphemeral = useCallback(
    async (urlEphemeral: string) => {
      try {
        setStatusState('wallet', { loading: true });
        const existingWallet = cookieService.getWalletCookie(NETWORK.EPHEMERAL);
        if (existingWallet && existingWallet.publicIp === urlEphemeral) {
          return;
        }
  ...
  const onDeleteAccountEphemeral = useCallback(async () => {
    try {
