...
export const useCollectionsQuery = (teamId: string | undefined) => {
	...
	console.log('useCollectionsQuery', apiUrl);
...
export const useNewCollectionMutation = (teamId: string | undefined) => {
...
export const useDeleteCollectionMutation = (teamId: string | undefined) => {
	const queryClient = useQueryClient();
	const axios = useAxios();
	const { getEndpoint } = useEndpoint();
...
export const useUpdateCollectionMutation = (teamId: string | undefined) => {
	const queryClient = useQueryClient();
	const axios = useAxios();
	const { getEndpoint } = useEndpoint();
