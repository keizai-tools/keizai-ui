...
export default function ConnectWalletDialog({
  ...
  function handleCreateAccount(replaceAutoGenerated = false) {
    setLoading(true);
    if (
      (wallet.TESTNET?.publicKey && !wallet.TESTNET.autoGenerated) ||
      (wallet.FUTURENET?.publicKey && !wallet.FUTURENET.autoGenerated)
      ...
      setShowWarning(true);
      setReplaceAutoGenerate(replaceAutoGenerated);
    } else {
      onCreateAccount(false, replaceAutoGenerated);
      setLoading(false);
    }
  }
  ...
  useEffect(() => {
    if (confirmCreateAccount) {
      onCreateAccount(false, replaceAutoGenerate);
      setConfirmCreateAccount(false);
      setReplaceAutoGenerate(false);
    }
  }, [confirmCreateAccount, onCreateAccount, replaceAutoGenerate]);
        ...
        >
          {loading ? (
            ...
            >
              ...
              <p className="text-white text-md center text-">Loading...</p>
            </div>
          ) : (
            <Fragment>
              <DialogHeader>
              ...
              <Accordion type="single">
                ...
                {wallet.FUTURENET?.publicKey && (
                  <AccordionItem value="futurenet">
                    <AccordionTrigger
                      onClick={() => toggleNetwork('futurenet')}
                    >
